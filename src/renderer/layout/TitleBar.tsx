...
const TitleBar: React.FC<TitleBarProps> = ({ isDarkTheme, onToggleTheme, onToggleLanguage }) => {
  ...
  return (
    <div className="flex items-center justify-between px-2 py-2 bg-transparent h-10 select-none drag bg-red-500">
      {/* App Title */}
      ...
      <div className="flex items-center space-x-4 no-drag">
        {/* Language switcher */}
        <button onClick={onToggleLanguage} className="p-2 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-md">
          <LanguageIcon />
        </button>
        ...
        <button onClick={handleClose} className="p-2 hover:bg-red-500 hover:text-white rounded-md" aria-label="Close">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
