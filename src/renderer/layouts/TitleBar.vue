...
<template>
  <div class="titlebar drag flex h-titlebar select-none items-center justify-between px-2 py-2 text-text-primary">
    ...
    <div class="no-drag flex items-center space-x-1">
      ...
      <button
        class="titlebar-button rounded-md p-2 transition-all duration-200 hover:bg-hover hover:text-text-primary"
      ...
      <button
        ...
        @click="toggleTheme"
      >
        <svg v-if="isDarkMode" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
